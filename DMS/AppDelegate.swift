...
//            [UIColor colorWithRed:0.93 green:0.80 blue:0.80 alpha:1.0]
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "CSDC.DMS" in the application's documents Application Support directory.
