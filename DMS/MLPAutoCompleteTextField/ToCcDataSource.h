...
@interface ToCcDataSource : NSObject <MLPAutoCompleteTextFieldDataSource>
...
@property (strong, nonatomic) NSMutableArray *listOne;
@property (strong, nonatomic) NSMutableArray *listTwo;
